...
image:https://ci.appveyor.com/api/projects/status/7e8hhrpu2p1avo76/branch/master?svg=true[Build Status", link="https://ci.appveyor.com/project/aalmiray/griffon/branch/master"]
