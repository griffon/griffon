 ...
 */
public class MinutesValue extends AbstractAtomicValue {
    public MinutesValue() {
    }

    public MinutesValue(@Nonnull Minutes arg) {
        setValue(requireNonNull(arg, ERROR_ARG_NULL));
    }

    public MinutesValue(@Nonnull Number arg) {
        setValue(requireNonNull(arg, ERROR_ARG_NULL));
    }

    @Nullable
    public Minutes minutesValue() {
