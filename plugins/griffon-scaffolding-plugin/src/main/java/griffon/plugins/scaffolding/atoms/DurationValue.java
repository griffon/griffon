 ...
 */
public class DurationValue extends AbstractAtomicValue {
    public DurationValue() {
    }

    public DurationValue(@Nonnull Duration arg) {
        setValue(requireNonNull(arg, ERROR_ARG_NULL));
    }

    public DurationValue(@Nonnull Number arg) {
        setValue(requireNonNull(arg, ERROR_ARG_NULL));
    }

    @Nullable
    public Duration yearsValue() {
