...
public class HandleObservable extends JavacAnnotationHandler<Observable> {
    @Override
    public void handle(AnnotationValues<Observable> annotation, JCAnnotation source, JavacNode annotationNode) {
        new ObservableHandler<JavacType, JavacField, JavacNode, JCTree>(annotationNode, source) {
            @Override
