...
@Named("scaffolding-groovy")
@ServiceProviderFor(Module.class)
public class ScaffoldingGroovyModule extends AbstractModule {
    @Override
    protected void doConfigure() {
        bind(CommandObjectDisplayHandler.class)
            .to(GroovyAwareCommandObjectDisplayHandler.class)
            .asSingleton();

        bind(ScaffoldingContext.class)
            .to(GroovyAwareScaffoldingContext.class);
    }
}
