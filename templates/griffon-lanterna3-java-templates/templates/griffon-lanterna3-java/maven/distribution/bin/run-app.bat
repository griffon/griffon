...
@rem ##########################################################################
@rem
@rem  ${project_name} startup script for Windows
@rem
@rem ##########################################################################
...
@rem Execute ${project_name}
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SAMPLE_OPTS%  -classpath "%CLASSPATH%" ${project_package}.Launcher %CMD_LINE_ARGS%
