...
defines a `Tab` that the main View will host. The application looks like the following the following picture
...
----
dependencies {
    griffon 'org.codehaus.griffon.plugins:griffon-fontawesome-plugin:1.2.0'
}
----
