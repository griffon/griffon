...
of the `@ServiceProviderFor` annotation in combination with {link_jipsy}. But given that we did not define a dependency in
...
[source,java]
.META-INF/services/griffon.core.artifact.GriffonController
----
include::{app-dir}/src/main/resources/META-INF/services/griffon.core.artifact.GriffonController[]
----

[source,java]
.META-INF/services/griffon.core.artifact.GriffonModel
----
include::{app-dir}/src/main/resources/META-INF/services/griffon.core.artifact.GriffonModel[]
----

[source,java]
.META-INF/services/griffon.core.artifact.GriffonService
----
include::{app-dir}/src/main/resources/META-INF/services/griffon.core.artifact.GriffonService[]
----

[source,java]
.META-INF/services/griffon.core.artifact.GriffonView
----
include::{app-dir}/src/main/resources/META-INF/services/griffon.core.artifact.GriffonView[]
----
