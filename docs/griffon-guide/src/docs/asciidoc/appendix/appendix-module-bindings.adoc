...
[source,java,options="nowrap"]
----
include::{subproject-base}lanterna-groovy{groovy-source}{package-base}/lanterna/groovy/LanternaBuilderModule.java[tags=bindings,indent=0]
----
...
[source,java,options="nowrap"]
----
include::{subproject-base}pivot-groovy{groovy-source}{package-base}/pivot/groovy/PivotBuilderModule.java[tags=bindings,indent=0]
----
