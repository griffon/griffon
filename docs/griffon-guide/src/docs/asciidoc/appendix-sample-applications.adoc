...
concerned in triggering a `com.googlecode.openbeans.PropertyChangeEvent` when a property changes value.
...
The following statistics show the amount tof lines per artifact required by both applications
