 ...
 * Registers _mavenCentral()_ , _http://dl.bintray.com/griffon/griffon-plugins_ and _mavenLocal()_ as default repositories.
...
| includeDefaultRepositories  | boolean | true              | Force inclusion of default repositories (`mavenCentral`).
