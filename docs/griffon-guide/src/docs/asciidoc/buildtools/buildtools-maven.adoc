...
the {link_griffon_pom}.

== Plugins

The `griffon-pom` configures the following plugins:
...
| org.codehaus.gmavenplus  | gmavenplus-plugin                 | 1.6
...
| org.bsc.maven            | maven-processor-plugin            | 3.3.2
