 ...
 */
public class ArtifactPersistence extends AbstractResourcePersistence {
    public ArtifactPersistence(String name, String root, Filer filer, Logger logger) {
        super(filer, name, logger, root + "META-INF/griffon/");
    }
