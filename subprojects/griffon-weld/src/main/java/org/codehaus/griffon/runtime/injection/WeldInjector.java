 ...
 * @since 2.0.0
 */
public class WeldInjector implements Injector<WeldContainer> {
    private final Weld weld;
    private final WeldContainer delegate;
    private final Object lock = new Object[0];
    @GuardedBy("lock")
    private boolean closed;


    public WeldInjector(@Nonnull Weld weld, @Nonnull WeldContainer delegate) {
        this.weld = requireNonNull(weld, "Argument 'weld' cannot be null");
    ...
    @Nonnull
    @Override
    public WeldContainer getDelegateInjector() {
        return delegate;
    }

    @Nonnull
    @Override
    public Injector<WeldContainer> createNestedInjector(@Nonnull Iterable<Binding<?>> bindings) {
        ...
        // return new WeldInjector(delegate.createChildInjector(moduleFromBindings(bindings)));
        return null;
    }
