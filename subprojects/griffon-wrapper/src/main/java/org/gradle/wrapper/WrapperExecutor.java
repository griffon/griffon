...
public class WrapperExecutor {
    ...
    public static WrapperExecutor forProjectDirectory(File projectDir, Appendable warningOutput) {
        return new WrapperExecutor(new File(projectDir, "wrapper/griffon-wrapper.properties"), new Properties(), warningOutput);
    }
    ...
    public void execute(String[] args, Install install, BootstrapMainStarter bootstrapMainStarter) throws Exception {
        ...
        File griffonHome = install.createDist(
                getDistribution(),
        ...
        bootstrapMainStarter.start(args, griffonHome);
    }
