 ...
 * @since 1.1.0
 */
public class DefaultResourcesInjector implements ResourcesInjector {
    ...
    private void doResourceInjection(Class klass, Object instance) {
        for (Field field : klass.getDeclaredFields()) {
            ...
            if (isBlank(defaultValue)) {
                value = app.resolveResource(key, args, app.getLocale());
            } else {
                value = app.resolveResource(key, args, defaultValue, app.getLocale());
            }
