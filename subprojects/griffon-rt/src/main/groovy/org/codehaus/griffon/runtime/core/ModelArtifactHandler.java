...
public class ModelArtifactHandler extends ArtifactHandlerAdapter {
    public ModelArtifactHandler(GriffonApplication app) {
        super(app, GriffonModelClass.TYPE, GriffonModelClass.TRAILING);
    }

    protected GriffonClass newGriffonClassInstance(Class clazz) {
        return new DefaultGriffonModelClass(getApp(), clazz);
    }
}