...
public class TableViewSelectionAdapter implements GriffonPivotAdapter, org.apache.pivot.wtk.TableViewSelectionListener {
    ...
    private CallableWithArgs<?> selectedRowChanged;
    ...
    public CallableWithArgs<?> getSelectedRowChanged() {
    ...
    public void setSelectedRowChanged(CallableWithArgs<?> selectedRowChanged) {
