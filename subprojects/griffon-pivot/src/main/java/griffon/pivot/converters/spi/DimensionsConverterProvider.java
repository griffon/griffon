...
public class DimensionsConverterProvider implements ConverterProvider<Dimensions> {
    @Override
    public Class<Dimensions> getTargetType() {
        return Dimensions.class;
    }

    @Override
    public Class<? extends Converter<Dimensions>> getConverterType() {
        return DimensionsConverter.class;
    }
}
