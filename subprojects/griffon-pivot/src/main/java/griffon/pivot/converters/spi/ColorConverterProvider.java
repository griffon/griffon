...
public class ColorConverterProvider implements ConverterProvider<Color> {
    @Override
    ...
    @Override
    public Class<? extends Converter<Color>> getConverterType() {
        return ColorConverter.class;
    }
}
