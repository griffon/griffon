 ...
 */
@AnnotationHandlerFor(griffon.annotations.beans.VetoablePropertySource.class)
...
public class VetoablePropertySourceASTTransformation extends AbstractASTTransformation implements VetoablePropertySourceConstants, AnnotationHandler {
    ...
    private static final ClassNode VETOABLE_PROPERTY_SOURCE_ANNOTATION_CNODE = makeClassSafe(griffon.annotations.beans.VetoablePropertySource.class);
