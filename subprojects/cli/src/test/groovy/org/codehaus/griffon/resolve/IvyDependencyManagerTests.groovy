...
/*
    void testDeclarePluginDependencies() {
        ...
        manager.parseDependencies {
            plugins {
                runtime "org.griffon.plugins:feeds:1.5"
        ...
        assertEquals "org.codehaus.griffon.plugins", dd.dependencyId.organisation
...
/*
    void testOverridePluginDependencies() {
        ...
        manager.parseDependencies("foo") {
            build "org.griffon:griffon-test:1.2"
            build "junit:junit:4.8.1"
        }

        final IvyNode[] buildDeps = manager.listDependencies("build")
        assertEquals 2, buildDeps.size()
        assertNotNull "griffon-test should be a dependency", buildDeps.find { it.moduleId.name == "griffon-test" }
    ...
    void testConfigurePluginDependenciesWithExclude() {
        ...
        assertEquals "griffon-test", buildDeps[0].moduleId.name
    }
*/
    ...
    void testResolveApplicationDependencies() {
        def settings = new BuildSettings()
        def manager = new IvyDependencyManager("test", "0.1",settings)
        settings.config.griffon.test.dependency.resolution = {
            test "org.griffon:griffon-test:1.2"
        }
        // test simple exclude
        manager.parseDependencies {
            inherits "test"
    ...
    void testDynamicAddDependencyDescriptor() {
        ...
        manager.addPluginDependency("foo",[group:"org.griffon", name:"grail-test", version:"1.2"])
    ...
    void testSerializerToMarkup() {
        ...
        def inherited = dependencies.find { it.@name == 'griffon-test' }
...
*/
    ...
    def getCurrentGriffonVersion() {
        ...
        def griffonVersion = props.'griffon.version'
...
*/
    ...
    void testParseDependencyDefinition() {
        ...
        assertTrue "should resolve to griffon home",resolvers[0].artifactPatterns[0].endsWith("lib/[module]-[revision](-[classifier]).[ext]")
        assertTrue "griffonHome() should be a file system resolver",resolvers[1] instanceof FileSystemResolver
        assertTrue "griffonHome() should be a file system resolver",resolvers[2] instanceof FileSystemResolver
...
/*
    void testCreateModuleDescriptor() {
        ...
        assert md.moduleRevisionId.organisation == "org.griffon.internal"
