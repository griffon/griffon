...
/**
 * Listens in on the execution of an entire test suite (or test "type" in Griffon) and creates
 * new TestRunListeners for each actual test class.
 */
class SuiteRunListener extends RunListener {

    private final GriffonTestEventPublisher eventPublisher
    ...
    SuiteRunListener(GriffonTestEventPublisher eventPublisher, JUnitReportsFactory reportsFactory, SystemOutAndErrSwapper outAndErrSwapper) {
