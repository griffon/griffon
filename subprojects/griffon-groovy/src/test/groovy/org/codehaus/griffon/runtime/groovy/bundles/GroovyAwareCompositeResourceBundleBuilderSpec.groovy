...
class GroovyAwareCompositeResourceBundleBuilderSpec extends Specification {
    ...
    def "Load Groovy and properties bundles"() {
        ...
        ResourceBundle bundle = bundleBuilder.create('org.codehaus.griffon.runtime.groovy.bundles.GroovyBundle')
    ...
    def "Load Java and properties bundles"() {
        ...
        ResourceBundle bundle = bundleBuilder.create('org.codehaus.griffon.runtime.groovy.bundles.JavaBundle')
