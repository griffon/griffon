...
NOTE: you may use both Gradle and Maven in the same project but we aware that you will be forced
to duplicate dependency management and other build tool specific plugins.
