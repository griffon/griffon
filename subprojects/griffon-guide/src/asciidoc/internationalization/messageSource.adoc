...
either properties files or Groovy scripts, please refer to the link:messageSourceConfiguration[configuration] section.
...
[subs="verbatim"]
----
assert getApplication().getMessageSource()
