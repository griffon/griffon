...
[source,java]
----
include::{subproject-base}swing-builder{groovy-source}{package-base}/swing/SwingBuilderModule.java[tags=bindings,indent=0]
----
...
[source,java]
----
include::{subproject-base}javafx-builder{groovy-source}{package-base}/javafx/JavaFXBuilderModule.java[tags=bindings,indent=0]
----
...
[source,java]
----
include::{subproject-base}lanterna-builder{groovy-source}{package-base}/lanterna/LanternaBuilderModule.java[tags=bindings,indent=0]
----
...
[source,java]
----
include::{subproject-base}pivot-builder{groovy-source}{package-base}/pivot/PivotBuilderModule.java[tags=bindings,indent=0]
----
