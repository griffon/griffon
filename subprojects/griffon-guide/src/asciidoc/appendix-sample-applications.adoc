...
[source,java]
----
include::{sample-swing-java}/griffon-app/models/sample/swing/java/SampleModel.java[]
----
...
[source,groovy]
----
include::{sample-swing-groovy}/griffon-app/models/sample/swing/groovy/SampleModel.groovy[]
----
...
[source,java]
----
include::{sample-swing-java}/griffon-app/controllers/sample/swing/java/SampleController.java[]
----
...
[source,groovy]
----
include::{sample-swing-groovy}/griffon-app/controllers/sample/swing/groovy/SampleController.groovy[]
----
<1> MVC member injected by +{link_mvc_group_manager}+
<2> Injected by JSR 330
<3> Automatically run off the UI thread
...
[source,java]
----
include::{sample-swing-java}/griffon-app/services/sample/swing/java/SampleService.java[]
----

.sample-swing-groovy/griffon-app/services/sample/swing/groovy/SampleService.groovy
[source,groovy]
----
include::{sample-swing-groovy}/griffon-app/services/sample/swing/groovy/SampleService.groovy[]
----
...
[source,java]
----
include::{sample-swing-java}/griffon-app/views/sample/swing/java/SampleView.java[]
----
<1> MVC member injected by +{link_mvc_group_manager}+
...
[source,groovy]
----
include::{sample-swing-groovy}/griffon-app/views/sample/swing/groovy/SampleView.groovy[]
----
<1> MVC member injected by +{link_mvc_group_manager}+
...
[source,java]
----
include::{sample-javafx-java}/griffon-app/models/sample/javafx/java/SampleModel.java[]
----
<1> Define a private field for the property
<2> Property accessor
...
----
include::{sample-javafx-groovy}/griffon-app/models/sample/javafx/groovy/SampleModel.groovy[]
----
<1> Observable property

Similarly to +@Observable+ we find that Groovy based JavaFX models can use another AST
transformation named +@FXBindable+. This transformation generates equivalent byte code
to the Java based Model we saw. +@FXBindable+ is delivered by http://groovyfx.org[GroovyFX]
which is automatically included as a dependency when +griffon-java-builder+ is added
to a project.
...
[source,java]
----
include::{sample-javafx-java}/griffon-app/controllers/sample/javafx/java/SampleController.java[]
----
<1> MVC member injected by +{link_mvc_group_manager}+
<2> Injected by JSR 330
<3> Automatically run off the UI thread
...
Di you spot any differences? No? That's because the two controllers are 100% identical.
...
----
include::{sample-javafx-groovy}/griffon-app/controllers/sample/javafx/groovy/SampleController.groovy[]
----
<1> MVC member injected by +{link_mvc_group_manager}+
<2> Injected by JSR 330
<3> Automatically run off the UI thread
...
[source,java]
----
include::{sample-javafx-java}/griffon-app/services/sample/javafx/java/SampleService.java[]
----
...
----
include::{sample-javafx-groovy}/griffon-app/services/sample/javafx/groovy/SampleService.groovy[]
----
...
[source,java]
----
include::{sample-javafx-java}/griffon-app/views/sample/javafx/java/SampleView.java[]
----
<1> MVC member injected by +{link_mvc_group_manager}+
<2> Create window and attach it to +{link_window_manager}+
...
----
include::{sample-javafx-groovy}/griffon-app/views/sample/javafx/groovy/SampleView.groovy[]
----
<1> MVC member injected by +{link_mvc_group_manager}+
<2> Create window and attach it to +{link_window_manager}+
<3> Apply component-to-model binding
...
.sample-lanterna-java/griffon-app/models/sample/SampleModel.java
[source,java]
----
include::{sample-lanterna-java}/griffon-app/models/sample/SampleModel.java[]
----
<1> Define a private field for the property
<2> Property accessor
<3> Property mutator must fire a +PropertyChangeEvent+
...
.sample-lanterna-groovy/griffon-app/conf/Config.groovy
[source,groovy]
----
include::{sample-lanterna-groovy}/griffon-app/conf/Config.groovy[]
----
...
.sample-lanterna-java/griffon-app/controllers/sample/SampleController.java
[source,java]
----
include::{sample-lanterna-java}/griffon-app/controllers/sample/SampleController.java[]
----
<1> MVC member injected by +{link_mvc_group_manager}+
<2> Injected by JSR 330
<3> Automatically run off the UI thread
...
.sample-lanterna-groovy/griffon-app/controllers/sample/SampleController.groovy
[source,groovy]
----
include::{sample-lanterna-groovy}/griffon-app/controllers/sample/SampleController.groovy[]
----
<1> MVC member injected by +{link_mvc_group_manager}+
<2> Injected by JSR 330
<3> Automatically run off the UI thread
...
.sample-lanterna-java/griffon-app/services/sample/SampleService.java
[source,java]
----
include::{sample-lanterna-java}/griffon-app/services/sample/SampleService.java[]
----

.sample-lanterna-groovy/griffon-app/services/sample/SampleService.groovy
[source,groovy]
----
include::{sample-lanterna-groovy}/griffon-app/services/sample/SampleService.groovy[]
----
...
.sample-lanterna-java/griffon-app/views/sample/SampleView.java
[source,java]
----
include::{sample-lanterna-java}/griffon-app/views/sample/SampleView.java[]
----
<1> MVC member injected by +{link_mvc_group_manager}+
<2> Create window and attach it to +{link_window_manager}+
<3> Apply component-to-model binding
...
.sample-lanterna-groovy/griffon-app/views/sample/SampleView.groovy
[source,groovy]
----
include::{sample-lanterna-groovy}/griffon-app/views/sample/SampleView.groovy[]
----
<1> MVC member injected by +{link_mvc_group_manager}+
<2> Create window and attach it to +{link_window_manager}+
...
[source]
----
include::{sample-lanterna-java}/griffon-app/i18n/messages.properties[]
----
...
.sample-pivot-java/griffon-app/models/sample/SampleModel.java
[source,java]
----
include::{sample-pivot-java}/griffon-app/models/sample/SampleModel.java[]
----
<1> Define a private field for the property
<2> Property accessor
<3> Property mutator must fire a +PropertyChangeEvent+
...
.sample-pivot-java/griffon-app/controllers/sample/SampleController.java
[source,java]
----
include::{sample-pivot-java}/griffon-app/controllers/sample/SampleController.java[]
----
<1> MVC member injected by +{link_mvc_group_manager}+
<2> Injected by JSR 330
<3> Automatically run off the UI thread
...
.sample-pivot-groovy/griffon-app/controllers/sample/SampleController.groovy
[source,groovy]
----
include::{sample-pivot-groovy}/griffon-app/controllers/sample/SampleController.groovy[]
----
<1> MVC member injected by +{link_mvc_group_manager}+
<2> Injected by JSR 330
<3> Automatically run off the UI thread
...
.sample-pivot-java/griffon-app/services/sample/SampleService.java
[source,java]
----
include::{sample-pivot-java}/griffon-app/services/sample/SampleService.java[]
----

.sample-pivot-groovy/griffon-app/services/sample/SampleService.groovy
[source,groovy]
----
include::{sample-pivot-groovy}/griffon-app/services/sample/SampleService.groovy[]
----
...
.sample-pivot-java/griffon-app/views/sample/SampleView.java
[source,java]
----
include::{sample-pivot-java}/griffon-app/views/sample/SampleView.java[]
----
<1> MVC member injected by +{link_mvc_group_manager}+
<2> Create window and attach it to +{link_window_manager}+
<3> Apply component-to-model binding
...
.sample-pivot-groovy/griffon-app/views/sample/SampleView.groovy
[source,groovy]
----
include::{sample-pivot-groovy}/griffon-app/views/sample/SampleView.groovy[]
----
<1> MVC member injected by +{link_mvc_group_manager}+
<2> Create window and attach it to +{link_window_manager}+
<3> Hook actions by convention
...
[source]
----
include::{sample-pivot-java}/griffon-app/i18n/messages.properties[]
----
