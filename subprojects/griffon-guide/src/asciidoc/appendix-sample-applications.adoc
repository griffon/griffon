...
[source,java]
----
include::{sample-lanterna-java}/griffon-app/models/sample/lanterna/java/SampleModel.java[]
----
<1> Define a private field for the property
<2> Property accessor
<3> Property mutator must fire a +PropertyChangeEvent+
...
[source,groovy]
----
include::{sample-lanterna-groovy}/griffon-app/conf/sample/lanterna/groovy/Config.groovy[]
----
...
[source,java]
----
include::{sample-lanterna-java}/griffon-app/controllers/sample/lanterna/java/SampleController.java[]
----
<1> MVC member injected by +{link_mvc_group_manager}+
<2> Injected by JSR 330
<3> Automatically run off the UI thread
...
[source,groovy]
----
include::{sample-lanterna-groovy}/griffon-app/controllers/sample/lanterna/groovy/SampleController.groovy[]
----
<1> MVC member injected by +{link_mvc_group_manager}+
<2> Injected by JSR 330
<3> Automatically run off the UI thread
...
[source,java]
----
include::{sample-lanterna-java}/griffon-app/services/sample/lanterna/java/SampleService.java[]
----

.sample-lanterna-groovy/griffon-app/services/sample/lanterna/groovy/SampleService.groovy
[source,groovy]
----
include::{sample-lanterna-groovy}/griffon-app/services/sample/lanterna/groovy/SampleService.groovy[]
----
...
[source,java]
----
include::{sample-lanterna-java}/griffon-app/views/sample/lanterna/java/SampleView.java[]
----
<1> MVC member injected by +{link_mvc_group_manager}+
<2> Create window and attach it to +{link_window_manager}+
<3> Apply component-to-model binding
...
[source,groovy]
----
include::{sample-lanterna-groovy}/griffon-app/views/sample/lanterna/groovy/SampleView.groovy[]
----
<1> MVC member injected by +{link_mvc_group_manager}+
<2> Create window and attach it to +{link_window_manager}+
