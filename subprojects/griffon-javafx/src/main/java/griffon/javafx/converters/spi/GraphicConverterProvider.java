...
public class GraphicConverterProvider implements ConverterProvider<Node> {
    @Override
    ...
    @Override
    public Class<? extends Converter<Node>> getConverterType() {
        return GraphicConverter.class;
    }
}
