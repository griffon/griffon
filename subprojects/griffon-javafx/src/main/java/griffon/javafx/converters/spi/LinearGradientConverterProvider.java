...
public class LinearGradientConverterProvider implements ConverterProvider<LinearGradient> {
    @Override
    public Class<LinearGradient> getTargetType() {
        return LinearGradient.class;
    }

    @Override
    public Class<? extends Converter<LinearGradient>> getConverterType() {
        return LinearGradientConverter.class;
    }
}
