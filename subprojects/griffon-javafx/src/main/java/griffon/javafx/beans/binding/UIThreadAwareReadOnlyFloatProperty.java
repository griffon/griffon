 ...
 * @since 3.0.0
 */
class UIThreadAwareReadOnlyFloatProperty extends ReadOnlyFloatPropertyDecorator implements UIThreadAware {
    UIThreadAwareReadOnlyFloatProperty(@Nonnull ReadOnlyFloatProperty delegate) {
        super(delegate);
    }
