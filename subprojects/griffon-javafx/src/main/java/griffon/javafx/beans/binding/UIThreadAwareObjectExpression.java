 ...
 * @since 3.0.0
 */
class UIThreadAwareObjectExpression<T> extends ObjectExpressionDecorator<T> implements UIThreadAware {
    UIThreadAwareObjectExpression(@Nonnull ObjectExpression<T> delegate) {
        super(delegate);
    }
