 ...
 * @since 3.0.0
 */
class UIThreadAwareDoubleExpression extends DoubleExpressionDecorator implements UIThreadAware {
    UIThreadAwareDoubleExpression(@Nonnull DoubleExpression delegate) {
        super(delegate);
    }
