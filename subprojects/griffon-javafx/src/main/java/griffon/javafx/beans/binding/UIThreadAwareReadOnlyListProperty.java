 ...
 * @since 3.0.0
 */
class UIThreadAwareReadOnlyListProperty<E> extends ReadOnlyListPropertyDecorator<E> implements UIThreadAware {
    UIThreadAwareReadOnlyListProperty(@Nonnull ReadOnlyListProperty<E> delegate) {
        super(delegate);
    }
