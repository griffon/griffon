 ...
 * @since 3.0.0
 */
public class ReadOnlyIntegerPropertyDecorator extends ReadOnlyIntegerProperty {
    private final ReadOnlyIntegerProperty delegate;

    public ReadOnlyIntegerPropertyDecorator(@Nonnull ReadOnlyIntegerProperty delegate) {
        this.delegate = requireNonNull(delegate, "Argument 'delegate' must not be null");
    }

    @Nonnull
    protected final ReadOnlyIntegerProperty getDelegate() {
        return delegate;
    }
