 ...
 * @since 3.0.0
 */
class UIThreadAwareReadOnlyIntegerProperty extends ReadOnlyIntegerPropertyDecorator implements UIThreadAware {
    UIThreadAwareReadOnlyIntegerProperty(@Nonnull ReadOnlyIntegerProperty delegate) {
        super(delegate);
    }
