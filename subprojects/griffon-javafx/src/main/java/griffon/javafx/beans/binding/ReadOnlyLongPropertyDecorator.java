 ...
 * @since 3.0.0
 */
public class ReadOnlyLongPropertyDecorator extends ReadOnlyLongProperty {
    private final ReadOnlyLongProperty delegate;

    public ReadOnlyLongPropertyDecorator(@Nonnull ReadOnlyLongProperty delegate) {
        this.delegate = requireNonNull(delegate, "Argument 'delegate' must not be null");
    }

    @Nonnull
    protected final ReadOnlyLongProperty getDelegate() {
        return delegate;
    }
