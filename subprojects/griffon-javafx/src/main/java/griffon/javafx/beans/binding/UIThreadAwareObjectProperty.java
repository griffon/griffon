 ...
 * @since 2.9.0
 */
class UIThreadAwareObjectProperty<T> extends ObjectPropertyDecorator<T> implements UIThreadAware {
    UIThreadAwareObjectProperty(@Nonnull ObjectProperty<T> delegate) {
        super(delegate);
    }
