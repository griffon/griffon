 ...
 * @since 2.9.0
 */
class UIThreadAwareIntegerProperty extends IntegerPropertyDecorator implements UIThreadAware {
    UIThreadAwareIntegerProperty(@Nonnull IntegerProperty delegate) {
        super(delegate);
    }
