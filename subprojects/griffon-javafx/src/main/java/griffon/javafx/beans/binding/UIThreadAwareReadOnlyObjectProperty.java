 ...
 * @since 3.0.0
 */
class UIThreadAwareReadOnlyObjectProperty<T> extends ReadOnlyObjectPropertyDecorator<T> implements UIThreadAware {
    UIThreadAwareReadOnlyObjectProperty(@Nonnull ReadOnlyObjectProperty<T> delegate) {
        super(delegate);
    }
