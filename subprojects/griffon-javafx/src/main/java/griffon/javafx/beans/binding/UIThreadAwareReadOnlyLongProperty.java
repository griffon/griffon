 ...
 * @since 3.0.0
 */
class UIThreadAwareReadOnlyLongProperty extends ReadOnlyLongPropertyDecorator implements UIThreadAware {
    UIThreadAwareReadOnlyLongProperty(@Nonnull ReadOnlyLongProperty delegate) {
        super(delegate);
    }
