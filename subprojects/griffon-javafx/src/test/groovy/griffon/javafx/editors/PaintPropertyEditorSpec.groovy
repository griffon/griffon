...
class PaintPropertyEditorSpec extends Specification {
    ...
    void setup() {
        ...
        PropertyEditorResolver.registerEditor(Color, ColorPropertyEditor)
        PropertyEditorResolver.registerEditor(LinearGradient, LinearGradientPropertyEditor)
        PropertyEditorResolver.registerEditor(RadialGradient, RadialGradientPropertyEditor)
    }
    ...
    void "Paint format '#format' is supported"() {
        ...
        PropertyEditor editor = new PaintPropertyEditor()
