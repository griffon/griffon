...
public class PolygonConverterProvider implements ConverterProvider<Polygon> {
    @Override
    ...
    @Override
    public Class<? extends Converter<Polygon>> getConverterType() {
        return PolygonConverter.class;
    }
}
