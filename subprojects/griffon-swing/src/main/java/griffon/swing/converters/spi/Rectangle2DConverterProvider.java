...
public class Rectangle2DConverterProvider implements ConverterProvider<Rectangle2D> {
    @Override
    public Class<Rectangle2D> getTargetType() {
        return Rectangle2D.class;
    }

    @Override
    public Class<? extends Converter<Rectangle2D>> getConverterType() {
        return Rectangle2DConverter.class;
    }
}
