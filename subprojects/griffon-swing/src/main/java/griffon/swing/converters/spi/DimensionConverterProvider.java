...
public class DimensionConverterProvider implements ConverterProvider<Dimension> {
    @Override
    public Class<Dimension> getTargetType() {
        return Dimension.class;
    }

    @Override
    public Class<? extends Converter<Dimension>> getConverterType() {
