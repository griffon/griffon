...
public class InsetsConverterProvider implements ConverterProvider<Insets> {
    @Override
    public Class<Insets> getTargetType() {
        return Insets.class;
    }

    @Override
    public Class<? extends Converter<Insets>> getConverterType() {
        return InsetsConverter.class;
    }
}
