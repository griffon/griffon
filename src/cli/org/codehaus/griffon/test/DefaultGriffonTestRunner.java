 ...
 */
public class DefaultGriffonTestRunner implements GriffonTestRunner {
    ...
    public DefaultGriffonTestRunner(File reportsDir, List<String> formats) {
    ...
    public TestResult runTests(TestSuite suite) {
        GriffonConsoleResultFormatter consoleFormatter = new GriffonConsoleResultFormatter();
