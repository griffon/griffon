...
//          boolean inTestSuite = System.getProperty("griffon.cli.testing") != null;
//          if(/*!application.isWarDeployed() && */GriffonUtil.isDevelopmentEnv() && !inTestSuite) {
...
//      }
  ...
  /**
   * This method will search the classpath for .class files inside the org.codehaus.griffon package
...
//                    ConfigSlurper slurper = new ConfigSlurper(GriffonUtil.getEnvironment());
//
//                    try {
...
//        for (Iterator i = pluginList.iterator(); i.hasNext();) {
//            GriffonPlugin plugin = (GriffonPlugin) i.next();
//            plugin.notifyOfEvent(GriffonPlugin.EVENT_ON_CONFIG_CHANGE, application.getConfig());
//        }
//    }

//    private void reloadPlugin(GriffonPlugin plugin) {
...
//    private class GriffonPluginChangeChecker extends Thread{
//        DefaultGriffonPluginManager pluginManager;
//        boolean enabled = true;
//
//        GriffonPluginChangeChecker(DefaultGriffonPluginManager pluginManager){
...
//                        sleep(DefaultGriffonPluginManager.SCAN_INTERVAL);
//                }
//            }catch(Exception e){
