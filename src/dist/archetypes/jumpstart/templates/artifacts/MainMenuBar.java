...
public class @artifact.name.plain@MenuBar {
    ...
    private static void fileMenu(JMenuBar menuBar) {
        ...
        menu.add(new JMenu(@artifact.name.plain@Actions.newAction()));
        menu.add(new JMenu(@artifact.name.plain@Actions.openAction()));
        menu.addSeparator();
    ...
    private static void editMenu(JMenuBar menuBar) {
        ...
        menu.add(new JMenu(@artifact.name.plain@Actions.undoAction()));
        menu.add(new JMenu(@artifact.name.plain@Actions.redoAction()));
        menu.addSeparator();
        menu.add(new JMenu(@artifact.name.plain@Actions.cutAction()));
        menu.add(new JMenu(@artifact.name.plain@Actions.copyAction()));
        menu.add(new JMenu(@artifact.name.plain@Actions.pasteAction()));
        menu.add(new JMenu(@artifact.name.plain@Actions.deleteAction()));
        menuBar.add(menu);
    }
